              ...
              .onTapGesture {
                ...
                if(currentScreen == "VERIFICATION"){
                  ...
                  if ((welcomeScreenOptions?["hideScreen"] as! Bool ) ) {
                    return dataStore.onCancelCallbackEvent(["message" : "Cancel by User on Verification Screen"])
                  }
                  else{
                  ...
                  hideVerificationScreen = true
                  hideWelcomeScreen = false
                  return dataStore.onCancelCallbackEvent(["message" : "Cancel by User"])
                }
                else{
                  return dataStore.onCancelCallbackEvent(["message" : "Cancel by User"])
                }
      ...
      ZStack(alignment: .bottom) {
        ...
        VStack {
          ...
          if((optionsList["sessionId"] as! String).isEmpty){
            return dataStore.onErrorCallbackEvent(["errorMessage" : "Invalid sessionId", "errorCause" : "missing sessionId or sessionId value is empty", "recoverySuggestion" : "please pass sessionId value in options" ])
          }
          
          let accessTokenData = optionsList["accessToken"] as! String
          
          if(accessTokenData.isEmpty){
            return dataStore.onErrorCallbackEvent(["errorMessage" : "Invalid accessToken", "errorCause" : "missing accessToken or accessToken value is empty", "recoverySuggestion" : "please pass accessToken value in options" ])
          }
          ...
          Task {
            do {
              ...
              do {
                ...
                return dataStore.onErrorCallbackEvent(["errorMessage" : error.errorDescription, "errorCause" : "", "recoverySuggestion" : error.recoverySuggestion ])
              }
            } catch {
              return dataStore.onErrorCallbackEvent(["errorMessage" :  "Unknown Error", "errorCause" : "", "recoverySuggestion" : "" ])
            }
          }
